...
?>
<nav class="mt-3" aria-label="<?= __d('file_storage', 'Page navigation') ?>">
	...
	<p class="text-center text-muted small mb-0">
		<?= $this->Paginator->counter(__d('file_storage', 'Page {{page}} of {{pages}}, showing {{current}} record(s) out of {{count}} total')) ?>
	</p>
</nav>
